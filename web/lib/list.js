...
!function (e, t) {
        ...
        return t.startState = function () {
            ...
            if (p != r && (p ? (d += " hmd-html-begin", P.htmlBlock = t.f) : d += " hmd-html-end"), (i || g) && (t.localMode && i || (d = d.replace("inline-code", "")), d += " line-HyperMD-codeblock line-background-HyperMD-codeblock-bg", g !== i && (g ? i || (d += " line-HyperMD-codeblock-begin line-background-HyperMD-codeblock-begin-bg") : d += " line-HyperMD-codeblock-end line-background-HyperMD-codeblock-end-bg")), s) {
                ...
                var _ = (t.listStack[t.listStack.length - 1] || 0) + 3,
                    k = o && /^\s+$/.test(v) && (!1 !== t.list || e.indentation() <= _), y = t.list && /formatting-list/.test(d);
    ...
    l.hmdInsertFile = H, U.defineOption("hmdInsertFile", O, function (e, t) {
        if (t && "boolean" != typeof t) "function" == typeof t && (t = {byDrop: !0, byPaste: !0, fileHandler: t}); else {
            var n = !!t;
            ...
            (l = i(r, {
                marker: o, cm: a, finish: function (r, i) {
                    return a.operation(function () {
                        ...
                        a.replaceRange(r, t, n), o.clear(), "number" == typeof i && a.setCursor({line: t.line, ch: t.ch + i})
                    })
    ...
    var P = x("ReadLink", F, I),
        q = Object.freeze({splitLink: N, Extensions: A, defaultOption: I, suggestedOption: j, ReadLink: F, getAddon: P}),
    ...
    le.prototype.mouseenter = function (e) {
        ...
        var n = t.getBoundingClientRect(), r = this.lineDiv.getBoundingClientRect(), i = this.tooltipDiv, o = this.xOffset;
    ...
    var Ee = function (t) {
        ...
        if (/\bimage-marker\b/.test(t.type) && "!" === t.string) {
            ...
            if (c === ke.OK) {
                ...
                d = N(u).url, d = n.hmdResolveURL(d), h = n.getRange({line: i, ch: l.ch + 2}, {line: i, ch: o.token.start - 1});
                var m = document.createElement("img"), p = n.markText(l, s, {clearOnEnter: !0, collapsed: !0, replacedWith: m});
    ...
    ze.prototype.setStatus = function (e, t) {
        ...
        var v = l.getRange({line: u.line + 1, ch: 0}, {line: f.line, ch: 0}),
            b = {editor: l, lang: a, marker: null, lineWidget: null, el: null, break: Be, changed: Be}, _ = b.el = r(v, b);
        if (!_) return b.marker.clear(), null;
        var k = document.createElement("div");
        k.className = Ke + i, k.style.minHeight = "1em", k.appendChild(_);
        var y = b.lineWidget = l.addLineWidget(f.line, k, {above: !1, coverGutter: !1, noHScroll: !1, showIfHidden: !1}),
    ...
    jt.prototype.procLine = function (e, t) {
        ...
        for (var s = T(n).extract(r), c = 0, d = 0; d < s.length; d++) {
            ...
            if (-1 !== this.tokenTypes.indexOf(h.type)) {
                for (var m = [{line: r, ch: h.begin}, {line: r, ch: h.end}], p = h.begin; c < f && u[3 * c + 1] < p;) c++;
            ...
            if (!c) {
                ...
                if (0 != b) {
                    if (!/^[\s\|]+$/.test(s) || o.line !== e.lastLine() && e.getStateAfter(o.line + 1).hmdTable === b) {
                        ...
                        }) : e.setCursor({line: o.line, ch: s.length}), e.replaceSelection(k), e.replaceSelection(_, "start")
    ...
    function en(e) {
        ...
        for (var p = 0; p < n.length; p++) {
            ...
            !_ && 0 < U.cmpPos(v, b) ? (b = (t = [v, b])[0], v = t[1]) : b === v && (b = g.anchor = {ch: v.ch, line: v.line});
            ...
            for (var n = new z(e), r = e.listSelections(), i = new Array(r.length), o = 0; o < r.length; o++) {
                ...
                if (d || T(e.getTokenAt(l).state)) {
                    ...
                    if (g.i_token === p.i_token) {
                        ...
                        line: u,
                        ch: g.token.end
                    }), p.i_token !== g.i_token && x(p.token) && e.replaceRange("", {line: u, ch: p.token.start}, {
                        line: u,
                        ch: p.token.end
                    })
                } else {
